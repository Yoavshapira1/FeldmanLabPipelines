...
`Cut_interactions_spesific_triggers.py`: Script to cut interactions using specific trigger points, using additional excel file holds information about the interactions.  
