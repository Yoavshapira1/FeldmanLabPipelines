...
def make_epochs(in_path, out_path):
    ...
    for file in os.listdir():
        ...
        for i in range(events.shape[0]):
            events[i][2] = i
        epochs = mne.Epochs(raw, events, tmin=-0.5, tmax=0.5, preload=True, baseline=None)
...
if __name__ == "__main__":
    IN_PATH = 'C:/Users/carme/Documents/Ruth Feldman LAB/anxiety experiment all/Linoys Analysis/2. Interacations seperated/control/Conflict_umbrella/'
    #'C:/Users/Linoy/Dropbox/post/to_epochs/Epochs_seperated/'
    OUT_PATH = 'C:/Users/carme/Documents/Ruth Feldman LAB/anxiety experiment all/Linoys Analysis/3. Epochs/control/Conflict_umbrella/'
